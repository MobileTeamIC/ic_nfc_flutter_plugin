...
SWIFT_CLASS("_TtC15ICNFCCardReader15EmulatorChecker")
@interface EmulatorChecker : NSObject
+ (BOOL)amIRunInEmulator SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)icMRZScannerCodeDismissedWithLastStep:(ICNFCLastStep)lastStep;
...
@class NSNumber;
@class NSData;
SWIFT_CLASS("_TtC15ICNFCCardReader16ICNFCCryptoSwift") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ICNFCCryptoSwift : NSObject
+ (NSString * _Nonnull)generateDigitRandomNumberWithLength:(NSInteger)length SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)generateKeyWithRandomNamespace SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nonnull)sha256Data:(NSString * _Nonnull)input length:(NSNumber * _Nullable)length SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)encryptWithRSAOAEPWithMessage:(NSData * _Nonnull)message pemPublicKey:(NSString * _Nonnull)pemPublicKey SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)decryptWithRSAOAEPWithCipherText:(NSData * _Nonnull)cipherText pemPrivateKey:(NSString * _Nonnull)pemPrivateKey SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)encryptChaCha20Poly1305WithData:(NSData * _Nonnull)data keyData:(NSData * _Nonnull)keyData nonceData:(NSData * _Nonnull)nonceData SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)decryptChaCha20Poly1305WithEncryptedData:(NSString * _Nonnull)encryptedData key:(NSData * _Nonnull)key nonce:(NSData * _Nonnull)nonce SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nullable)encryptAESGcmWithData:(NSData * _Nonnull)data keyHex:(NSString * _Nonnull)keyHex SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nullable)decryptAESGcmWithEncryptedData:(NSData * _Nonnull)encryptedData keyHex:(NSString * _Nonnull)keyHex SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)icNFCReadingChipWithState:(ICNFCReaderState)state progress:(NSInteger)progress error:(NSString * _Nonnull)error logError:(NSDictionary<NSString *, id> * _Nonnull)logError retryCount:(NSInteger)retryCount;
...
SWIFT_CLASS("_TtC15ICNFCCardReader16JailbreakChecker")
